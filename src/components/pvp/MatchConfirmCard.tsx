...
export const MatchConfirmCard = ({ match, onJoin, onCancel, userId }: MatchConfirmCardProps) => {
      ...
      >
        <Card className="glass-card backdrop-blur-2xl bg-white/10 border-white/20 rounded-3xl p-8 relative">
            ...
            <div className="glass-card p-4 rounded-xl bg-white/5 backdrop-blur-xl border border-white/20">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-white/80 text-sm font-medium">Host</span>
                </div>
          ...
          >
            <Button
              onClick={onJoin}
              className="w-full bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white font-bold py-6 text-lg rounded-xl shadow-xl"
            >
              Entrar na Partida
            ...
            <Button
              onClick={onCancel}
              variant="outline"
              className="w-full bg-white/5 border-white/20 hover:bg-white/10 text-white font-semibold py-4 rounded-xl"
            >
              Cancelar
            </Button>
          </motion.div>
