...
export function GoalDetailsModal({
  ...
  const getProgressColor = () => {
    if (progressPercentage >= 80) return "text-primary";
        ...
        <DialogHeader>
          <DialogTitle className="flex items-center gap-3 text-3xl">
            <div className="relative">
              {/* Glow */}
              <div className="absolute inset-0 bg-gradient-to-br from-primary via-accent to-secondary rounded-full blur-xl opacity-60 animate-pulse" />
              {/* Ícone em container vibrante */}
              <div className="relative w-14 h-14 rounded-full bg-gradient-to-br from-primary via-accent to-secondary flex items-center justify-center shadow-2xl ring-4 ring-background/20">
                <Target className="w-8 h-8 text-primary-foreground" strokeWidth={3} />
              </div>
            </div>
        ...
        <div className="space-y-4 py-3">
          ...
          <div className="space-y-2">
            ...
            <div className="relative w-full h-3 bg-muted rounded-full">
              ...
              <div className="absolute left-0 top-0 h-full rounded-full bg-gradient-to-r from-primary via-secondary to-accent transition-all duration-300" style={{
              width: `${progressPercentage}%`
            }} />
              
              {/* Bolinha indicadora */}
              <div className="absolute top-1/2 -translate-y-1/2 -translate-x-1/2 w-6 h-6 rounded-full bg-primary shadow-lg border-2 border-background transition-all duration-300" style={{
