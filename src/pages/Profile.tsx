...
export default function Profile() {
  ...
  return <div className="min-h-screen bg-background p-4 lg:p-8">
      <div className="max-w-3xl mx-auto">
        <Button variant="ghost" onClick={() => navigate("/dashboard")} className="mb-6 text-white bg-[#a65eed]">
        ...
        y: 0
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              {profile?.age && <div className="space-y-2">
                  <Label>Idade</Label>
          ...
          <Card>
            ...
            <CardContent>
              {!showChangePassword ? <Button onClick={() => setShowChangePassword(true)}>
                  Alterar Senha
                </Button> : <form onSubmit={handleChangePassword} className="space-y-4">
                  <div className="space-y-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="newPassword" type="password" placeholder="Mínimo 6 caracteres" value={newPassword} onChange={e => setNewPassword(e.target.value)} required />
                  </div>
        ...
        <ConfirmDialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog} title="Deletar Conta" description="Tem certeza que deseja deletar sua conta? Esta ação não pode ser desfeita e todos os seus dados serão permanentemente removidos." confirmText="Sim, deletar minha conta" onConfirm={handleDeleteAccount} variant="danger" />
      </div>
    </div>;
}